...
%description -l pl
libwmfun jest bibliotek╠ dla WindowMakera, ktСra wyposa©a go w funkcje
tworzenia tekstur. WiЙcej informacji znajdziesz po zainstalowaniu tego
pakietu w %{_defaultdocdir}/%{name}-%{version}/README.

%package devel
Summary:	Header files etc to develop libwmfun applications
Summary(pl):	Pliki nagЁСwkowe i inne do libwmfun
...
Pliki nagЁСwkowe i inne do libwmfun.
